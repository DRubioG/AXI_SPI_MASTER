...
proc create_ipi_design { offsetfile design_name } {
	...
	set AXI_SPI_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI_SPI:1.0 AXI_SPI_0 ]
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AXI_SPI_0/S_AXI]
	connect_bd_net [get_bd_pins AXI_SPI_0/s_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_SPI_0/s_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI_SPI_0_S_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:AXI_SPI:1.0]]]]
